...
def validate_evidence_report(world: EpisodeWorld, report: EvidenceReport | None) -> tuple[float, list[str]]:
    ...
    previous_report = world.final_report
    ...
    try:
        ...
        useful_cited = [
            ...
            if capture.photo_id in cited_ids
            and capture.targets_visible
            and any(capture.target_quality(target_id) >= thermal_threshold for target_id in capture.targets_visible)
        ]
        ...
        world.final_report = previous_report
